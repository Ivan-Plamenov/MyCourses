...
if time_left > series_time:
    print(f"You have enough time to watch {series_name} and left with {time_round} minutes free time.")

else:
    print(f"You don't have enough time to watch {series_name}, you need {time_round} more minutes.")