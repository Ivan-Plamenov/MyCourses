...
amountOfToys = amountOfPuzzles + amountOfDolls + amountOfTedyBears 
+ amountOfMinions + amountOfTrucks;
totalPriceOfToys = amountOfPuzzles * 2.6 + amountOfDolls * 3 + amountOfTedyBears * 4.1
+ amountOfMinions * 8.2 + amountOfTrucks * 2;
